...
const { updateProfile } = require('./patient.controller')
...
module.exports = {doctorAppointments, cancelAppointment, completeAppointment, changeAvailablity, doctorProfile, updateProfile, doctorDashboard}